...
public struct BoxItem {
    ...
    public func boxLeft(_ left: CGFloat?) -> BoxItem {
        return Self.init(view: view, layout: layout.with(.left, ==left))
    }
    ...
    public func boxRight(_ right: CGFloat?) -> Self {
        return Self.init(view: view, layout: layout.with(.right, ==right))
    }
    ...
    public func boxLeftRight(_ left: CGFloat?, _ right: CGFloat?) -> BoxItem {
        return Self.init(view: view, layout: layout.with(.left, ==left).with(.right, ==right))
    }
    ...
    public func boxTop(_ top: CGFloat?) -> Self {
        return Self.init(view: view, layout: layout.with(.top, ==top))
    }
    ...
    public func boxBottom(_ bottom: CGFloat?) -> Self {
        return Self.init(view: view, layout: layout.with(.bottom, ==bottom))
    }
    ...
    public func boxTopBottom(_ top: CGFloat?, _ bottom: CGFloat?) -> BoxItem {
        return Self.init(view: view, layout: layout.with(.top, ==top).with(.bottom, ==bottom))
    }
